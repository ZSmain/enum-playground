...
def _print_context(obj=None, *requested_props, print_function_name=False, label:str ='', function_name=None, use_repr=False, force=False):
    """
    ...
    - Args:
        ...
        - user_repr: If True, use the object's __repr__ method to print it
